...
#ifndef header_texture_provider
#define header_texture_provider
...
public:
	...
	//: Create texture.
	virtual void create(int width, int height, int format, int depth, int border) = 0;

	//: Retrieve image data from texture.
	virtual CL_PixelBuffer get_pixeldata(CL_PixelFormat &format, int level) = 0;

	//: Upload image to texture.
	virtual void set_image(CL_PixelBuffer &image, int level, int border, int format) = 0;
	...
	virtual void set_border_color(double red, double green, double blue, double alpha) = 0;

	//: Set texture priority.
	virtual void set_priority(double priority) = 0;

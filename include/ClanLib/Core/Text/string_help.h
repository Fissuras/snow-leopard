...
#ifndef header_string_help
#define header_string_help
...
public:
	...
	static CL_TempString float_to_text(float value);
	
	static CL_TempString8 float_to_local8(float value);
	
	static CL_TempString16 float_to_ucs2(float value);
	...
	static CL_TempString double_to_text(double value);
	
	static CL_TempString8 double_to_local8(double value);
	
	static CL_TempString16 double_to_ucs2(double value);
